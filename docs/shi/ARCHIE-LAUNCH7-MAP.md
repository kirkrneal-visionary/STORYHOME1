...
- **Acceptance:** First paint is not white void on Streets; Imagery paints without a zoom ritual; liberty filters coalesce null numeric props; parcel lines at close zoom; `npm run test:map-zoom-precision`.
