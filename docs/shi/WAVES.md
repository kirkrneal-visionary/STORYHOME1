...
## Current
### STORY-WALK · SW-6 READY (start tomorrow)
Share Agent World link/card. Kickoff: [`STORY-WALK-SW6-READY.md`](./STORY-WALK-SW6-READY.md)

### Owner sticky — do not forget
**Public Agent World still needs more polish** (visitor surface, presence feel, CTAs, empty states, mobile). Track beside SW-6.

## Next
- SW-6 share → SW-7 compositor → SW-8 harden per [`STORY-WALK.md`](./STORY-WALK.md)  
