...
**Shipped coded waves:** `STORY-CONTINUUM-VISIBILITY` · `STORY-MESSAGES-REFERRALS` · `STORY-ANALYTICS-FOUNDATION` · `STORY-ANALYTICS-DESTINATION` · `ARCHIE-INTELLIGENCE-SCENARIOS` · `ARCHIE-COUNTY-OPS-SCALE` · `STORY-FEEL-WAVE-1` · `STORY-FEEL-WAVE-2` · `STORY-FEEL-WAVE-3` · `STORY-FEEL-WAVE-4` · `STORY-GLASS-AB` · `STORY-GLASS-C` · `STORY-GLASS-D` (Home/social glass).

**Next coded wave (when green-lit):** Story Glass Phase E (Work) · optional models / Messages E2E. See [`shi/STORY-GLASS.md`](./shi/STORY-GLASS.md).
