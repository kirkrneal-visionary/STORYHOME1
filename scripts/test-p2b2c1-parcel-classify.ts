...
assert.doesNotMatch(read("scripts/p2b2c1-parcel-classify-primitive.sql"), /0079|alter table public\.county_parcels|listings\.local_place/);
assert.doesNotMatch(read("scripts/p2b2c1-parcel-classify-harness.sql"), /update public\.county_parcels|local_place_product_activation|ETJ|CITY_SOURCE/);
