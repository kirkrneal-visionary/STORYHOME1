...
values
  ('polk_cad',        '48373', 'Polk County',        'arcgis',
   ...
   'Polk CAD public ArcGIS FeatureServer'),
  ...
  ('trinity_cad',     '48455', 'Trinity County',     'file',
   null,
   'No public ArcGIS FeatureServer — drop CAD export (GeoJSON/CSV/shapefile) or agent enters details'),
  ('tyler_cad',       '48457', 'Tyler County',       'file',
   'https://tylercad.net/wp-content/uploads/2025/12/Parcels.zip',
   'Download-only CAD: shapefile has geometry + prop_id; agent supplies ownership/legal/serial detail'),
  ('san_jacinto_cad', '48407', 'San Jacinto County', 'file',
   null,
   'No public ArcGIS FeatureServer — drop CAD export or agent enters details'),
  ('liberty_cad',     '48291', 'Liberty County',     'file',
   null,
   'No public ArcGIS FeatureServer — drop CAD export or agent enters details'),
  ('walker_cad',      '48471', 'Walker County',      'file',
   null,
   'No public ArcGIS FeatureServer — drop CAD export or agent enters details'),
  ('montgomery_cad',  '48339', 'Montgomery County',  'file',
   null,
   'Optional for Cleveland — drop CAD export when available')
