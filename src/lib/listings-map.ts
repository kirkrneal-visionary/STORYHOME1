...
/**
 * Public listing columns. Never include seller_access_code or the 0043
 * hash/lookup columns. Codes are issued through ensure/rotate RPCs and
 * checked only on the server via seller_portal_by_code.
 */
