...
export const SHI_WAVES: ShiWave[] = [
  ...
  {
    id: "ARCHIE-POSITION",
    name: "Parcel position · Phase 1–4 worth a look · P5 objective · P6 phone card · P7 context · P8 proof · Compare facts",
    ...
    frontend: [
      ...
      "Compare + Strongest Sites use parcel position — same highway count can match; frontage / second road / acres differ",
    ],
    backend: [
      ...
      "Compare prefers parcel-position-v1 · primary-road AADT only · Find Strongest Sites kept",
    ],
    outOfScope: [
  ...
  },
  {
    ...
    status: "current",
    frontend: [
      "Map canvas + tools / sheet / drawer — not a webpage with a map in it",
      "Mobile: live-drag bottom sheet (collapsed / peek / expanded / full)",
      "Desktop: research drawer reflows the map; collapse returns space",
      "Expanded map is a view state — same session, obvious Exit map",
      "County Observation Feed lives inside the research panel",
      "Search is an action, not a permanent left column",
    ],
    backend: [
      "research-workspace-v2 session snapshot (county + view state)",
