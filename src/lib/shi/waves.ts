...
export const SHI_WAVES: ShiWave[] = [
  ...
  },
  {
    ...
    goal: "Agent World under StoryHome OS; Living Mark + play respect + analytics live; next = share link then Story Walk film.",
    status: "current",
    frontend: [
      "SW-1…SW-5 LIVE: Agent World, library, presence, play caps, plain-English analytics",
      "SW-6 READY: share Agent World URL/card (kickoff docs/shi/STORY-WALK-SW6-READY.md)",
    ...
    outOfScope: [
      "Implementing SW-6 until owner starts tomorrow",
